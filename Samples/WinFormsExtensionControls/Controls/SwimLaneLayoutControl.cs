...
namespace WinFormsExtensionControls.SwimLaneLayout {
  [ToolboxItem(false)]
  public partial class SwimLaneLayoutControl : System.Windows.Forms.UserControl {
    ...
    public SwimLaneLayoutControl() {
      ...
      radBtnDivisions.CheckedChanged += (s, e) => _PartitionBy('d');
...
";
    ...
    private void Setup() {
      ...
      myDiagram.Layout = new CustomSwimLaneLayout {
    ...
    private void _PartitionBy(char a) {
      ...
      var layout = myDiagram.Layout as CustomSwimLaneLayout;
  ...
  public class CustomSwimLaneLayout : Northwoods.Go.Layouts.Extensions.SwimLaneLayout {
