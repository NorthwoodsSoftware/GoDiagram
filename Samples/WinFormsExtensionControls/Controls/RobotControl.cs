...
namespace WinFormsExtensionControls.Robot {
  public partial class RobotControl : System.Windows.Forms.UserControl {
    ...
    private void dragFromPaletteBtn_Click(object sender, EventArgs e) {
    ...
    private void dragSelectNodesBtn_Click(object sender, EventArgs e) {
      var alpha = _Diagram.FindNodeForKey("Alpha");
      if (alpha == null) return;
    ...
    private void contextMenuClickAlphaBtn_Click(object sender, EventArgs e) {
      var alpha = _Diagram.FindNodeForKey("Alpha");
      if (alpha == null) return;
    ...
    private void clickLambdaBtn_Click(object sender, EventArgs e) {
    ...
    private void doubleClickLambdaBtn_Click(object sender, EventArgs e) {
      var lambda = _Diagram.FindNodeForKey("Lambda");
      if (lambda == null) return;
      var loc = lambda.Location;
