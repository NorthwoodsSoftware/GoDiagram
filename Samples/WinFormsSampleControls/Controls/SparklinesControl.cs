...
namespace WinFormsSampleControls.Sparklines {
  [ToolboxItem(false)]
  public partial class SparklinesControl : System.Windows.Forms.UserControl {
    private Diagram myDiagram;
    
    public SparklinesControl() {
      InitializeComponent();
...
";
    ...
    private void Setup() {
      ...
      var sparkLine = new Panel(PanelLayoutHorizontal.Instance) {
        Alignment = Spot.Left,
