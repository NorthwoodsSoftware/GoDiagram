...
namespace WinFormsSampleControls.ControlGauges {
  [ToolboxItem(false)]
  public partial class ControlGaugesControl : System.Windows.Forms.UserControl {
...
";
    ...
    private void Setup() {
      ...
      myDiagram.NodeTemplateMap.Add("Horizontal",
        new Node(PanelLayoutAuto.Instance).Set(
          CommonNodeStyle()
        ).Bind(
          CommonNodeBinding()
        ).Add(
          ...
          new Panel(PanelLayoutTable.Instance) { Margin = 1, Stretch = Stretch.Fill }.Add(
            ...
            new Panel(PanelLayoutSpot.Instance) {
              ...
              new Panel(PanelLayoutGraduated.Instance) {
                Name = "SCALE",
      ...
      myDiagram.NodeTemplateMap.Add("NeedleMeter",
        new Node(PanelLayoutAuto.Instance).Set(
          ...
          new Panel(PanelLayoutSpot.Instance).Add(
            new Panel(PanelLayoutPosition.Instance).Add(
              new Panel(PanelLayoutGraduated.Instance) {
                Name = "SCALE",
                Margin = 10
              }.Bind(
      ...
      myDiagram.NodeTemplateMap.Add("CircularMeter",
        new Node(PanelLayoutTable.Instance).Set(
          CommonNodeStyle()
        ).Bind(
          CommonNodeBinding()
        ).Add(
