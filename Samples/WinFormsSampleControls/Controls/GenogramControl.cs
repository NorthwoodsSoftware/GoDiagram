...
namespace WinFormsSampleControls.Genogram {
  [ToolboxItem(false)]
  public partial class GenogramControl : System.Windows.Forms.UserControl {
    ...
    public GenogramControl()
    {
      ...
      goWebBrowser1.Html = @"
        ...
        <p>For a simpler family tree, see the <a href=""FamilyTree"">family tree sample</a>.</p>
        <p>
          ...
          <ul>
            ...
            <li><b>a</b>, a list of the attributes or markers that the person has</li>
          </ul>
        </p>
      ";
    ...
    private void Setup() {
      ...
      MyDiagram.Layout = new GenogramLayout {
        Direction = 90,
        LayerSpacing = 30,
        ColumnSpacing = 30
      };
      ...
      MyDiagram.NodeTemplateMap["LinkLabel"] =
        new Node {
          Selectable = false,
          Width = 1,
          Height = 1,
      ...
      MyDiagram.LinkTemplate = new Link { // for Parent-child relationships
