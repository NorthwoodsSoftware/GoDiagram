...
namespace WinFormsSampleControls.MultipleArrowheads {
  [ToolboxItem(false)]
  public partial class MultipleArrowheadsControl : System.Windows.Forms.UserControl {
    private Diagram MyDiagram;
    
    public MultipleArrowheadsControl() {
      InitializeComponent();
