...
namespace WinFormsSampleControls.CircularLayoutSample {
  [ToolboxItem(false)]
  public partial class CircularLayoutSampleControl : System.Windows.Forms.UserControl {
    ...
    public CircularLayoutSampleControl() {
      InitializeComponent();
