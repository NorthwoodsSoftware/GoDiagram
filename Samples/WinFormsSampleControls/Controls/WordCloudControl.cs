...
namespace WinFormsSampleControls.WordCloud {
  ...
  public partial class WordCloudControl : System.Windows.Forms.UserControl {
   ...
   <p>
    ...
    This example shows the text from the <a href="".. / index.html"">GoDiagram home page</a>,
...
";
    ...
    private string _WordString = @"
          GoDiagram is a feature-rich JavaScript library for implementing custom interactive diagrams and complex visualizations across modern web browsers and platforms. GoDiagram makes constructing JavaScript diagrams of complex nodes, links, and groups easy with customizable templates and layouts.
          ...
          GoDiagram is pure JavaScript, so users get interactivity without requiring round-trips to servers and without plugins. GoDiagram normally runs completely in the browser, rendering to an HTML5 Canvas element or SVG without any server-side requirements. GoDiagram does not depend on any JavaScript libraries or frameworks, so it should work with any HTML or JavaScript framework or with no framework at all.
          ...
          Learn
          Get started with a step-by-step description of how to build a JavaScript diagram in HTML using GoDiagram and some model data.
          ...
          Read our introduction for a overview of GoDiagram concepts and features, including hundreds of live interactive examples embedded right in each page.
