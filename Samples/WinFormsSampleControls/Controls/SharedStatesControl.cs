...
namespace WinFormsSampleControls.SharedStates {
  [ToolboxItem(false)]
  public partial class SharedStatesControl : System.Windows.Forms.UserControl {
...
";
    ...
    private void Setup() {
      ...
      MyDiagram.NodeTemplate = new Node(PanelLayoutAuto.Instance).Bind(
