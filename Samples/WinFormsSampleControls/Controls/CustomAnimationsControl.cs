...
namespace WinFormsSampleControls.CustomAnimations {
  [ToolboxItem(false)]
  public partial class CustomAnimationsControl : System.Windows.Forms.UserControl {
    ...
    public CustomAnimationsControl() {
      ...
      creation.DataSource = new ComboItem[] {
        new ComboItem { ID = "spinIn", Text = "Spin In" },
        new ComboItem { ID = "fadeIn", Text = "Fade In" },
        new ComboItem { ID = "floatIn", Text = "Float In" },
        new ComboItem { ID = "zoomIn", Text = "Zoom In" },
        new ComboItem { ID = "none", Text = "--None--" }
      };
      deletion.DisplayMember = "Text";
      deletion.DataSource = new ComboItem[] {
        new ComboItem { ID = "spinOut", Text = "Spin Out" },
        new ComboItem { ID = "fadeOut", Text = "Fade Out" },
        new ComboItem { ID = "floatOut", Text = "Float Out" },
        new ComboItem { ID = "zoomOut", Text = "Zoom Out" },
        new ComboItem { ID = "bounceOut", Text = "Bounce Out" },
        new ComboItem { ID = "none", Text = "--None--" }
      };
      links.DisplayMember = "Text";
      links.DataSource = new ComboItem[] {
        new ComboItem { ID = "bezier", Text = "Bezier Curve" },
        new ComboItem { ID = "orthogonal", Text = "Orthogonal Curve" },
        new ComboItem { ID = "linear", Text = "Linear (no animation)" }
      };
    ...
    private void Setup() {
      ...
      _Diagram.LinkDrawn += (s, e) => {
        ...
        var animation = new Animation();
        var linkChoice = ((ComboItem)links.SelectedItem).ID;
      ...
      _Diagram.SelectionDeleting += (s, e) => {
        var deletionSelection = ((ComboItem)deletion.SelectedItem).ID;
        var animation = new Animation();
        var diagram = e.Diagram;
      ...
      _Diagram.ClipboardPasted += (s, e) => {
        var creationSelection = ((ComboItem)creation.SelectedItem).ID;
