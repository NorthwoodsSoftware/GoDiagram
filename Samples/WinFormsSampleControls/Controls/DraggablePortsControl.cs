...
namespace WinFormsSampleControls.DraggablePorts {
  [ToolboxItem(false)]
  public partial class DraggablePortsControl : System.Windows.Forms.UserControl {
...
";
    ...
    void SetupDiagram(IEnumerable<NodeData> nodes, IEnumerable<LinkData> links) {
      ...
      model.AddNodeDataCollection(newnodes);
      ...
      model.AddLinkDataCollection(newlinks);
    }
