...
namespace Northwoods.Go.Tools.Extensions {
  ...
  public class RowResizingTool : Tool {
    ...
    /// <summary>
    /// This read-only property returns the <see cref="Panel"/> of type <see cref="PanelLayoutTable.Instance"/> whose rows are being resized.
    ...
    /// </summary>
    /// <param name="newPoint"></param> the value returned by the call to <see cref="ComputeResize"/>
