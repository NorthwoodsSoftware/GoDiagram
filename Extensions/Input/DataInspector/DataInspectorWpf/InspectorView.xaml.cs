...
namespace Northwoods.Go.Extensions {
  /// <summary>
  /// Implements the <see cref="IInspector"/> interface for the WPF platform.
  /// </summary>
  public partial class InspectorView : UserControl, IInspector {
    ...
    public void UpdateUI(Inspector inspector, bool rebuild = false) {
      ...
      if (!rebuild) {
        ...
        if (!rows.Any()) table.Visibility = System.Windows.Visibility.Hidden;
      ...
      table.Visibility = rows.Any() ? System.Windows.Visibility.Visible : System.Windows.Visibility.Hidden;
    }
    ...
    private void BuildPropertyRow(Grid table, Inspector.Row row, Inspector inspector) {
      table.RowDefinitions.Add(new System.Windows.Controls.RowDefinition());
